    ...
    document.querySelectorAll('.box').forEach(i1 => {
        if (i1.style.backgroundColor == 'rgb(155, 222, 237)') {
            ...
            document.querySelectorAll('.box').forEach(i2 => {
                ...
                if (i2.style.backgroundColor == 'rgb(153, 255, 153)' && i2.innerText.length !== 0) {
...
function whosTurn(toggle, a, aup, aside, item, flip) {
        ...
        if (item.innerText == `${toggle}pawn`) {
            ...
            if (tog % 2 !== 0 && aup < 800) {
                ...
                if (aup == 200 && document.getElementById(`b${a + 100}`).innerText.length == 0) {
                    document.getElementById(`b${a + 100}`).style.backgroundColor = 'rgb(153, 255, 153)'
                    if (aup == 200 && document.getElementById(`b${a + 200}`).innerText.length == 0) {
                        document.getElementById(`b${a + 200}`).style.backgroundColor = 'rgb(153, 255, 153)'
                    }
                }
                ...
                if (aside < 8 && document.getElementById(`b${a + 100 + 1}`).innerText.length !== 0) {
                    document.getElementById(`b${a + 100 + 1}`).style.backgroundColor = 'rgb(153, 255, 153)'
                }
    ...
    if (item.innerText == `${toggle}king`) {
        ...
        if (aside < 8) {
            document.getElementById(`b${a + 1}`).style.backgroundColor = 'rgb(153, 255, 153)'
    ...
    if (item.innerText == `${toggle}rook`) {
        ...
        for (let i = 1; i < 9; i++) {
            ...
            if ((a + i * 100) < 900 && document.getElementById(`b${a + i * 100}`).innerText == 0) {
                document.getElementById(`b${a + i * 100}`).style.backgroundColor = 'rgb(153, 255, 153)'
            }
        ...
        for (let i = 1; i < 9; i++) {
            ...
            if ((a + i) < (aup + 9) && document.getElementById(`b${a + i}`).innerText == 0) {
                document.getElementById(`b${a + i}`).style.backgroundColor = 'rgb(153, 255, 153)'
            }
    ...
    if (item.innerText == `${toggle}bishop`) {
        ...
        for (let i = 1; i < 9; i++) {
            if (i < (900 - aup) / 100 && i < 9 - aside && document.getElementById(`b${a + i * 100 + i}`).innerText.length == 0) {
                document.getElementById(`b${a + i * 100 + i}`).style.backgroundColor = 'rgb(153, 255, 153)'
            }
    ...
    if (item.innerText == `${toggle}knight`) {
        ...
        if (aside < 7 && aup < 800) {
            document.getElementById(`b${a + 100 + 2}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
        if (aside < 7 && aup > 200) {
            document.getElementById(`b${a - 100 + 2}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
        if (aside < 8 && aup < 700) {
            document.getElementById(`b${a + 200 + 1}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
        if (aside > 1 && aup < 700) {
            document.getElementById(`b${a + 200 - 1}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
        if (aside > 2 && aup < 800) {
            document.getElementById(`b${a - 2 + 100}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
        if (aside > 2 && aup > 100) {
            document.getElementById(`b${a - 2 - 100}`).style.backgroundColor = 'rgb(153, 255, 153)'
        }
...
document.querySelectorAll('.box').forEach(item => {
    ...
    item.addEventListener('click', function () {
        ...
        if (item.style.backgroundColor == 'rgb(153, 255, 153)' && item.innerText.length == 0) {
            tog = tog + 1
        }
        ...
        else if (item.style.backgroundColor == 'rgb(153, 255, 153)' && item.innerText.length !== 0) {
...
document.querySelectorAll('.box').forEach(ee => {
    ee.addEventListener('click', function () {
        z = z + 1
        if (z % 2 == 0 && ee.style.backgroundColor !== 'rgb(153, 255, 153)' && ee.style.backgroundColor !== 'aqua') {
            coloring()
        }
    })
})
